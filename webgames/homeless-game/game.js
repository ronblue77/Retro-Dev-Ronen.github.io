...
// include: C:\Users\ronbl\AppData\Local\Temp\tmpsce6vs3z.js
...
Module['FS_createPath']("/", "fonts", true, true);
    ...
    loadPackage({"files": [{"filename": "/fonts/arial.ttf", "start": 0, "end": 1045960}, {"filename": "/fonts/david.ttf", "start": 1045960, "end": 1141600}], "remote_package_size": 1141600});

  })();

// end include: C:\Users\ronbl\AppData\Local\Temp\tmpsce6vs3z.js
// include: C:\Users\ronbl\AppData\Local\Temp\tmpbv3hhbqg.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\ronbl\AppData\Local\Temp\tmpbv3hhbqg.js
// include: C:\Users\ronbl\AppData\Local\Temp\tmpv_aqvxy3.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\ronbl\AppData\Local\Temp\tmpv_aqvxy3.js
